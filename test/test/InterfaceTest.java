...
public class InterfaceTest {	
	...
	static String recognize_ir_code="{\"receiver\":2,\"sender\":0,\"ircode\":\"33,04,00,00,24,00,26,82,1b,02,40,82,17,06,40,c1,11,1a,c2,00,11,2a,c3,00,30,4d,b2,fc,03,00,ff,c2,00,14,3a,c1,11,15,c2,00,11,2a,c3,00,30,4d,b2,fc,03,00,ff,00\",\"applianceType\":541,\"ctrolID\":10014}";
    ...
    static String switch_profileSet="{\"receiver\":0,\"sender\":2,\"profileSetID\":4,\"ctrolID\":10003}";
    ...
    static String set_trigger_header="{\"receiver\":2,\"sender\":0,\"trigger\":{\"modifyTime\":\"2015-10-13 16:14:10\",\"createTime\":\"2015-10-13 16:14:10\",\"validFlag\":1,\"triggerName\":\"加湿机自动除湿\",\"profileID\":24,\"triggerID\":130,\"description\":\"室内湿度达到恒定的湿度时关闭加湿机\",\"ctrolID\":10016,\"isAbstract\":1},\"ctrolID\":10016}";
    static String set_monitor_status="{\"receiver\":0,\"sender\":1,\"ctrolID\":10015,\"time\":\"2015-10-13 16:14:10\",\"monitorStatus\":2}";
...
//
	...
	public static void set_trigger_header() throws JSONException, UnknownHostException, IOException, InterruptedException {
		count++;
		JSONObject json=new JSONObject(set_trigger_header);
		json.put("sender", 0) ; //      "sender":    中控:0 ; 手机:1 ; 设备控制服务器:2;
		json.put("receiver", 2) ;
		Message msg1 = new Message((short) 0x164d, System.currentTimeMillis()
				/ 1000 % 86400 * 10000 + count + "_15", json);
		msg1.writeBytesToSock2(sock);
		System.out.println("Send:"+msg1.toString());
	...
	public static void set_monitor_status() throws JSONException, UnknownHostException, IOException, InterruptedException {
		count++;
		JSONObject json=new JSONObject(set_monitor_status);
		//json.put("sender", 1) ; //      "sender":    中控:0 ; 手机:1 ; 设备控制服务器:2;
		//json.put("receiver", 2) ;
		//json.put("device",);
		Message msg1 = new Message((short)0x166a, System.currentTimeMillis()
				/ 1000 % 86400 * 10000 + count + "_15", json);
		msg1.writeBytesToSock2(sock);
		System.out.println("Send:"+msg1.toString());
