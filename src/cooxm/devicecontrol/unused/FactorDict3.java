...
public class FactorDict3 extends Factor3 {
	static final String FactorDictionaryTable = "dic_st_factor";
	static Map<Integer, FactorDict3> factorDictMap=new HashMap<Integer, FactorDict3>(); 
    ...
    */
	...
	public FactorDict3 getOneFactor(MySqlClass mysql) throws SQLException	
	{
		FactorDict3 fd= null;//new FactorDictionary();
		...
		+ "  from "				
		+FactorDict3.FactorDictionaryTable
...
//		for(String line:records){			
	...
	public void InitializeFactorDictMap(MySqlClass mysql) throws SQLException	
	{
		...
		for(String line:records){			
			...
			FactorDict3.factorDictMap.put(fd.factorID, fd)	;
		}
