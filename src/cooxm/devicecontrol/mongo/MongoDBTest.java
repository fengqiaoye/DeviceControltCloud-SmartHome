package cooxm.devicecontrol.mongo;

/** 
 * @author Chen Guanghua E-mail: richard@cooxm.com
 * @version Created：May 7, 2015 3:23:18 PM 
 */
...
public class MongoDBTest extends TestCase {
	...
	public void setUp() throws Exception {
		...
		mongo = new Mongo("172.16.35.173", 27017);
		// 得到一个test的数据库，如果mongoDB中没有这个数据库，当向此库中添加数据的时候会自动创建
		db = mongo.getDB("test");
		//((Object) db).authenticate("test", "test".toCharArray());
	...
	public void testConditionQuery() {
		...
		print("find by ID(50a1ed9965f413fa025166db):"+oneUser);
